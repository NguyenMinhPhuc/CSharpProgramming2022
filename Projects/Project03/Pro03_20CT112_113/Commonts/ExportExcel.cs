...
namespace Pro03_20CT112_113.Commonts
{
    public class ExportExcel
    {

        // Cách 1: nỗi chuỗi, ghi file
        ...
        public static void ExportExcelByInterrop(string path,DataGridView dgv,int rowBegin=1, string fontName = "Arial",int fontsizeTieude=14,int fontsizeNoiDung=12)
        {
